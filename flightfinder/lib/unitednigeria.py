...
from flightfinder.lib.constants import LOCATIONS, UNITED_NIGERIA_URL
...
class UnitedNigeria:
    ...
    def extract_data_from_item(self, item):
        ...
        try:
            ...
            destination_string = locations_element[1].text if len(locations_element) > 1 else None
            ...
            flight_number_string = flight_number_element.text if flight_number_element else None
